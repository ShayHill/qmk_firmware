...
#define S_NAV LT(1,KC_S)
#define D_MOUSE LT(2,KC_D)
#define F_SYMR LT(3,KC_F)
#define J_SYML LT(4,KC_J)
#define E_NAV LT(1,KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_2(  // alpha
        KC_Q    , KC_W    , E_CTL   , KC_R    , KC_T    , KC_Y    , KC_U    , I_CTL   , KC_O    , KC_P    ,
    ...
    [1] = LAYOUT_split_3x5_2(  // nav
        ...
        KC_RSFT , XXXXXXX , _______ , KC_LGUI , _______ , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_RSFT ,
    ...
    [4] = LAYOUT_split_3x5_2(  // syml
        ...
        _______ , KC_EXLM , KC_LBRC , KC_RBRC , KC_MUTE , _______ , _______ , _______ , _______ , _______ ,
    ...
    [5] = LAYOUT_split_3x5_2(  // fun
        ...
        KC_LSFT , KC_F4   , KC_F5   , KC_F6   , KC_F11  , _______ , KC_LGUI , XXXXXXX , _______ , KC_RSFT ,
